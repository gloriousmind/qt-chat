...
//使用Udp广播发送信息
void Widget::sendMessage(MessageType type, QString Message_Information)
{
    QByteArray data;
    ...
    switch(type)
    {
        case Message:
        {
            ...
            QString serverAddress = Message_Information;
            out << serverAddress << getMessage();
        ...
        case FileName:
        {
            ...
            out << serverAddress << clientAddress << fileName;
            break;
        }
        case Refuse:
        {
            QString refused_serverAddress = Message_Information;
            out << refused_serverAddress;
            break;
        }
    }
